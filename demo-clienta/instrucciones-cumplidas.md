...
- En el rango iPad, el header incorpora un icono de monitor para forzar una versión compacta del menú horizontal de escritorio. La elección se conserva al navegar, prevalece sobre la hamburguesa y el mismo control cambia a una tablet para volver a la vista responsive sin repetir la animación de apertura.
- La línea vertical del bloque de usuario conserva una separación simétrica: tiene el mismo aire respecto del icono circular anterior y de la plantita del nombre.
