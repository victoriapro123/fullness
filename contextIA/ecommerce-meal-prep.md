...
- El formulario de Meal preps mantiene un borrador local automático para cambios sin guardar. Al elegir otro producto o crear uno nuevo, debe pedir confirmación antes de descartar el borrador; al guardar correctamente, se elimina. Si la validación nativa bloquea el guardado por campos obligatorios, el mensaje debe dejar claro que el borrador sigue protegido.
