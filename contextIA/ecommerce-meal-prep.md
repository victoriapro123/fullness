...
- Ajuste visual 2026-07-28: las ilustraciones de beneficios no deben verse como miniaturas cuadradas ni como tarjetas independientes. Sus WebP usan un papel calido incrustado cercano a `#F9E9CF`; las superficies de producto, seleccion y lightbox que las contienen deben usar ese mismo tono, sin borde ni fondo individual en cada icono, para que se lean solamente la ilustracion y su nombre.
