...
- Los valores nutricionales combinan campos guiados y el bloque avanzado `Datos nutricionales JSON`. El JSON debe seguir aceptando claves personalizadas y conservar las que Cecilia ya use; la validación se hace al guardar y exige un objeto JSON válido.
